...
test.group('Product System', (group) => {
  ...
  test('should create a new product', async ({ client }) => {
    ...
    const response = await client.post('/api/products').header('cookie', cookie).json({
      name: 'Test Product',
      price: 10000,
      stock: 10,
  ...
  test('should get all products with pagination', async ({ client }) => {
    ...
    const response = await client.get('/api/products?page=1&limit=2').header('cookie', cookie)
  ...
  test('should search products', async ({ client }) => {
    ...
    const response = await client.get('/api/products?search=Apple').header('cookie', cookie)
  ...
  test('should export products to CSV', async ({ client }) => {
    ...
    const response = await client.get('/api/products/export').header('cookie', cookie)
